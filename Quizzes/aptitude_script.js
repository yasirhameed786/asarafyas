...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fetch aptitude questions from API
    ...
    // Function to fetch aptitude questions from API
    async function fetchAptitudeQuestions() {
        const apiUrl = 'https://opentdb.com/api.php?amount=10&category=15&type=multiple'; // Example URL for fetching 10 aptitude questions
