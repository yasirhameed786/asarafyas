...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fetch biology questions from API
    ...
    // Function to fetch biology questions from API
    async function fetchBiologyQuestions() {
        const apiUrl = 'https://opentdb.com/api.php?amount=10&category=27&type=multiple'; // Category 27 represents Biology questions
